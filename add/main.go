...
import (
	...
	"github.com/cage1016/gokit-gae/internal/app/add/transports"
	pb "github.com/cage1016/gokit-gae/pb/add"
)
...
func main() {
	...
	go startGRPCServer(ctx, wg, endpoints, cfg.grpcPort, hs, logger)
